...
const PregnancyTrackers = () => {
  ...
  const [newAppointment, setNewAppointment] = useState({ date: '', description: '', type: 'checkup' });
  ...
  const symptomsByTrimester = {
    first: ['Morning sickness', 'Fatigue', 'Breast tenderness', 'Food aversions', 'Frequent urination', 'Bloating', 'Mood swings', 'Headaches'],
    second: ['Baby movements', 'Increased energy', 'Nasal congestion', 'Backache', 'Growing belly', 'Stretched skin/itchiness', 'Leg cramps', 'Heartburn'],
    third: ['Shortness of breath', 'Trouble sleeping', 'Braxton Hicks', 'Swelling', 'Pelvic pressure', 'Frequent urination', 'Back pain', 'Fatigue']
  };
    ...
    <div className="h-screen bg-gradient-to-b from-pink-50 to-purple-50 flex">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <header className="text-center mb-12">
          <h1 className="text-4xl font-bold text-purple-800 mb-2 ml-20">Bloom</h1>
          <p className="text-pink-600 ml-20">Your Pregnancy Journey Companion</p>
        </header>
        ...
        <div className="max-w-5xl mx-auto ml-80">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-8">
            <h2 className="text-2xl font-semibold text-gray-800 mb-4">When is your baby due?</h2>
            <div className="flex flex-col md:flex-row items-center gap-4">
              ...
              />
              <button 
                className="bg-purple-600 text-white px-6 py-3 rounded-md hover:bg-purple-700 transition duration-300 w-full md:w-auto"
              >
                Set Due Date
              </button>
            </div>
            ...
            <>
              ...
              <div className="bg-white rounded-lg shadow-md p-6 mb-8">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                  <div className="text-center p-4 bg-pink-50 rounded-lg">
                    ...
                    <p className="text-4xl font-bold text-purple-700">{currentWeek}</p>
                    <p className="text-sm text-gray-500 mt-2">of 40 weeks</p>
                  </div>
                  <div className="text-center p-4 bg-purple-50 rounded-lg">
                    <h3 className="text-lg text-gray-600 mb-1">Trimester</h3>
                    <p className="text-2xl font-bold text-purple-700 capitalize">{currentTrimester}</p>
                  </div>
                  <div className="text-center p-4 bg-pink-50 rounded-lg">
                    <h3 className="text-lg text-gray-600 mb-1">Baby Size</h3>
                    <p className="text-2xl font-bold text-purple-700">{babySize}</p>
                  </div>
                  <div className="text-center p-4 bg-purple-50 rounded-lg">
                    <h3 className="text-lg text-gray-600 mb-1">Days Remaining</h3>
                    <p className="text-4xl font-bold text-purple-700">{daysRemaining}</p>
                  </div>
                </div>
              ...
              <div className="bg-white rounded-lg shadow-md overflow-hidden mb-8">
                <div className="flex border-b">
                  <button 
                    className={`px-6 py-3 font-medium ${activeTab === 'overview' ? 'bg-purple-100 text-purple-800 border-b-2 border-purple-600' : 'text-gray-600 hover:bg-purple-50'}`}
                    onClick={() => setActiveTab('overview')}
                  >
                    Overview
                  </button>
                  <button 
                    className={`px-6 py-3 font-medium ${activeTab === 'symptoms' ? 'bg-purple-100 text-purple-800 border-b-2 border-purple-600' : 'text-gray-600 hover:bg-purple-50'}`}
                    onClick={() => setActiveTab('symptoms')}
                  >
                    Symptoms
                  </button>
                  <button 
                    className={`px-6 py-3 font-medium ${activeTab === 'appointments' ? 'bg-purple-100 text-purple-800 border-b-2 border-purple-600' : 'text-gray-600 hover:bg-purple-50'}`}
                    onClick={() => setActiveTab('appointments')}
                  >
                    Appointments
                  </button>
                  <button 
                    className={`px-6 py-3 font-medium ${activeTab === 'weight' ? 'bg-purple-100 text-purple-800 border-b-2 border-purple-600' : 'text-gray-600 hover:bg-purple-50'}`}
                    onClick={() => setActiveTab('weight')}
                  >
                    Weight
                  </button>
                  <button 
                    className={`px-6 py-3 font-medium ${activeTab === 'notes' ? 'bg-purple-100 text-purple-800 border-b-2 border-purple-600' : 'text-gray-600 hover:bg-purple-50'}`}
                ...
                <div className="p-6">
                  ...
                  {activeTab === 'overview' && (
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                      {/* Fetal Development */}
                      <div>
                        <h2 className="text-2xl font-semibold text-purple-800 mb-4">Baby at Week {fetalDevelopmentData?.week}</h2>
                        ...
                        <div className="mb-6 bg-purple-50 p-4 rounded-lg">
                          ...
                          <div className="text-center text-sm text-gray-500 italic">
                            Illustration of fetal development at week {fetalDevelopmentData?.week}
                          </div>
                        </div>
                        
                        <div className="bg-pink-50 p-4 rounded-lg">
                          <h3 className="text-lg font-medium text-purple-700 mb-2">Development Milestones</h3>
                          <p className="text-gray-700">{fetalDevelopmentData?.data}</p>
                        </div>
                      </div>
                      
                      {/* Quick Summary */}
                      <div>
                        <h2 className="text-2xl font-semibold text-purple-800 mb-4">Your Pregnancy Summary</h2>
                        
                        {/* Due Date Info */}
                        <div className="bg-white border border-purple-100 rounded-lg p-4 mb-4 shadow-sm">
                          <h3 className="text-lg font-medium text-purple-700 mb-2">Important Dates</h3>
                          <p className="text-gray-700 mb-1"><span className="font-medium">Due Date:</span> {formatDate(dueDate)}</p>
                          <p className="text-gray-700"><span className="font-medium">Days Remaining:</span> {daysRemaining}</p>
                        </div>
                        
                        {/* Next Appointment */}
                        <div className="bg-white border border-purple-100 rounded-lg p-4 mb-4 shadow-sm">
                          <h3 className="text-lg font-medium text-purple-700 mb-2">Next Appointment</h3>
                          {upcomingAppointments.length > 0 ? (
                            <div>
                              <p className="text-gray-700 mb-1">
                                <span className="font-medium">{formatDate(upcomingAppointments[0].date)}</span>
                              </p>
                              <p className="text-gray-700">{upcomingAppointments[0].description}</p>
                              <span className="inline-block bg-purple-100 text-purple-800 text-xs px-2 py-1 rounded mt-2">
                                {appointmentTypes.find(type => type.value === upcomingAppointments[0].type)?.label || 'Appointment'}
                              </span>
                            </div>
                          ) : (
                        ...
                        {/* Recent Symptoms */}
                        <div className="bg-white border border-purple-100 rounded-lg p-4 mb-4 shadow-sm">
                          <h3 className="text-lg font-medium text-purple-700 mb-2">Your Recent Symptoms</h3>
                  ...
                  {activeTab === 'symptoms' && (
                    <div>
                      <h2 className="text-2xl font-semibold text-purple-800 mb-4">Symptom Tracker</h2>
                      
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        {/* Common Symptoms */}
                        <div>
                          <h3 className="text-lg font-medium text-gray-700 mb-3">Common Symptoms in {currentTrimester.charAt(0).toUpperCase() + currentTrimester.slice(1)} Trimester</h3>
                          ...
                          <h3 className="text-lg font-medium text-gray-700 mb-3">Add New Symptom</h3>
                        ...
                        {/* Your Symptoms */}
                        <div>
                          <h3 className="text-lg font-medium text-gray-700 mb-3">Your Recorded Symptoms</h3>
                          {userSymptoms.length > 0 ? (
                            <div className="bg-white border border-purple-100 rounded-lg p-4">
                              <ul className="space-y-2">
                                {userSymptoms.map((symptom, index) => (
                                  <li key={index} className="flex items-center justify-between bg-purple-50 p-3 rounded-md">
                            ...
                            <div className="bg-white border border-purple-100 rounded-lg p-8 text-center">
                              ...
                              <p className="text-gray-500 text-sm mt-2">Add your first symptom using the form on the left</p>
                            </div>
                          )}
                        </div>
                      </div>
                  ...
                  {activeTab === 'appointments' && (
                    <div>
                      <h2 className="text-2xl font-semibold text-purple-800 mb-4">Appointment Tracker</h2>
                      
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        {/* Add Appointment */}
                        <div>
                          <h3 className="text-lg font-medium text-gray-700 mb-3">Add New Appointment</h3>
                          <div className="bg-white border border-purple-100 rounded-lg p-4">
                        ...
                        <div>
                          <h3 className="text-lg font-medium text-gray-700 mb-3">Upcoming Appointments</h3>
                          {upcomingAppointments.length > 0 ? (
                            <div className="space-y-3">
                              {upcomingAppointments.map((apt, index) => (
                                <div key={index} className="bg-white border-l-4 border-pink-400 rounded-lg p-4 shadow-sm">
                                  <div className="flex justify-between">
                                    <p className="font-medium text-purple-800">{formatDate(apt.date)}</p>
                                    <span className="inline-block bg-purple-100 text-purple-800 text-xs px-2 py-1 rounded">
                                      {appointmentTypes.find(type => type.value === apt.type)?.label || 'Appointment'}
                                    </span>
                                  </div>
                                  <p className="text-gray-700 mt-1">{apt.description}</p>
                                  <button 
                                    onClick={() => {
                            ...
                            <div className="bg-white border border-purple-100 rounded-lg p-8 text-center">
                              <p className="text-gray-500 italic">No upcoming appointments</p>
                              <p className="text-gray-500 text-sm mt-2">Add your first appointment using the form on the left</p>
                            </div>
                          )}
                        </div>
                      </div>
                  ...
                  {activeTab === 'weight' && (
                    <div>
                      <h2 className="text-2xl font-semibold text-purple-800 mb-4">Weight Tracker</h2>
                      
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        {/* Add Weight */}
                        <div>
                          <h3 className="text-lg font-medium text-gray-700 mb-3">Add New Entry</h3>
                          <div className="bg-white border border-purple-100 rounded-lg p-4">
                            <div className="space-y-4">
                              <div>
                                <label className="block text-gray-700 text-sm font-medium mb-1">Date</label>
                              ...
                              <div>
                                <label className="block text-gray-700 text-sm font-medium mb-1">Weight (lbs)</label>
                                <input
                                  type="number"
                        ...
                        {/* Weight History */}
                        <div>
                          <h3 className="text-lg font-medium text-gray-700 mb-3">Weight History</h3>
                          <div className="bg-white border border-purple-100 rounded-lg p-4">
                            {weightTracker.length > 0 ? (
                              <div className="space-y-4">
                                ...
                                {/* Weight Table */}
                                <div className="mt-4">
                                  <h4 className="text-md font-medium text-gray-700 mb-2">Recent Entries</h4>
                                  <div className="overflow-x-auto">
                                    <table className="min-w-full divide-y divide-gray-200">
                                      ...
                                      <tbody className="bg-white divide-y divide-gray-200">
                                        {weightTracker.slice().reverse().slice(0, 5).map((entry, index) => {
                                          const prevEntry = index > 0 ? weightTracker.slice().reverse()[index-1] : null;
                                          ...
                                          return (
                                            <tr key={entry.id}>
                                              ...
                                              <td className={`px-4 py-2 whitespace-nowrap text-sm ${changeColor}`}>
                                                {change > 0 ? '+' : ''}{change} lbs
                                              </td>
                      ...
                      {weightTracker.length > 0 && (
                        <div className="mt-8">
                          <h3 className="text-lg font-medium text-gray-700 mb-3">Weight Summary</h3>
                          <div className="bg-white border border-purple-100 rounded-lg p-4">
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                              <div className="p-4 bg-purple-50 rounded-lg">
                                <p className="text-sm text-gray-500">Starting Weight</p>
                                <p className="text-xl font-semibold text-purple-800">
                                  {weightTracker.length > 0 ? `${weightTracker[0].weight} lbs` : '—'}
                                </p>
                              </div>
                              <div className="p-4 bg-purple-50 rounded-lg">
                                <p className="text-sm text-gray-500">Current Weight</p>
                                <p className="text-xl font-semibold text-purple-800">
                                  {weightTracker.length > 0 ? `${weightTracker[weightTracker.length - 1].weight} lbs` : '—'}
                                </p>
                              </div>
                              <div className="p-4 bg-purple-50 rounded-lg">
                                ...
                                <p className="text-xl font-semibold text-purple-800">
                                  {weightTracker.length > 1 
                                    ? `${(weightTracker[weightTracker.length - 1].weight - weightTracker[0].weight).toFixed(1)} lbs` 
                                    : '—'}
                                </p>
                              </div>
                            </div>
                            ...
                            <div className="mt-4">
                              <h4 className="text-md font-medium text-gray-700 mb-2">Recommended Weight Gain</h4>
                              <p className="text-sm text-gray-500 mb-2">
                                Based on pre-pregnancy BMI, recommended weight gain typically ranges:
                              </p>
                              <ul className="text-sm text-gray-600 space-y-1 ml-4 list-disc">
                                <li>Underweight (BMI &lt; 18.5): 28-40 lbs</li>
                                <li>Normal weight (BMI 18.5-24.9): 25-35 lbs</li>
                  ...
                  {activeTab === 'notes' && (
                    <div>
                      <h2 className="text-2xl font-semibold text-purple-800 mb-4">Pregnancy Journal</h2>
